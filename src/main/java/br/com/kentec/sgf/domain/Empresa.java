...
public class Empresa implements Serializable {
	...
	@Column(name="status_empresa", nullable = true, length = 10)
	...
	public String toString() {
		return "CadastroEmpresa [id=" + id + ", cpfCnpj=" + cpfCnpj + ", nomeFantasia=" + nomeFantasia
				+ ", razaoSocial=" + razaoSocial + ", dataDeConstituicao=" + dataDeConstituicao + ", inscricaoEstadual="
				...
				+ dataDoCadastro + ", certificador=" + certificador + ", statusEmpresa=" + statusEmpresa + "]";
	}
}
